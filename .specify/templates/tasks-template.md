...
- **Web app (default)**: `backend/src/`, `frontend/src/`, `tests/` at each project root
- **Single project**: `src/`, `tests/` at repository root
- **Mobile**: `api/src/`, `ios/src/` or `android/src/`
- Paths shown below assume the web app structure; adjust based on plan.md structure if different
...
Task: "Contract test for [endpoint] in tests/contract/test_[name].spec.ts"
Task: "Integration test for [user journey] in tests/integration/test_[name].spec.ts"
